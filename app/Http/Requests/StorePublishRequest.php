...
class StorePublishRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'etage' => 'bail|nullable|integer|min:0|max:10',
                    ...
                    if (in_array($extension, ['mp4', 'webm'])) {
                        ...
                        try {
                            ...
                            $duration = $ffprobe->format($value->getRealPath())
                                ->get('duration');
                            if ($duration < 60) {
                                $fail('video trop courte ,choisir une video d\'au moins 1mn ');
                            }
                            if ($duration > 300) {
    ...
    public  function messages(): array
    {
        return [
            ...
            'form_logement.required' => 'le type de logement est requis',
            'form_logement.in' => 'le type de logement est invalide',
            'type_cour.in' => 'le type de cour est invalide',
            'type_cour.required' => 'le type de cour est requis',
            'type_sol.required' => 'le type de sol est requis',
            'type_sol.in' => 'le type de sol est invalide',
            'prix.required' => 'le prix est requis',
            'prix.min' => 'Minimum 15000',
            'prix.max' => 'max 999999999',
            'etage.required' => 'etage est requise.',

            'etage.integer' => 'etage doit etre un nombre entier.',
            ...
            'meublée.required' => 'cocher une case',
            'plafonnée.required' => 'cocher une case',
